...
function HomePage() {
  return (
    <div className="bg-bgFlare h-screen flex flex-col items-center bg-no-repeat bg-center bg-cover px-[60px] pt-[70px]">
      <HomeOptions />
      <button className="mt-[58px] cursor-pointer mx-auto bg-primaryColor rounded-[50px] px-[92px] py-[20px] flex gap-x-[16px] items-center text-white text-base font-semibold">
